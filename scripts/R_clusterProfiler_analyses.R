...
print("Many figures are going to be showed, but please double check the parameters used (default) and the possibilities within https://yulab-smu.top/biomedical-knowledge-mining-book/enrichplot.html. it is likely that some of the plots should be redo manually to optimize them...")
...
print("Remember that to visualize particular pathways of interest in KEGG, the functions pathway() and browseKEGG can be used, https://yulab-smu.top/biomedical-knowledge-mining-book/clusterprofiler-kegg.html#visualize-enriched-kegg-pathways")
print("Here all the pathways that may be of interest (i..e pval < 0.05) are shown for all alternatives")
...
print("Remember that to visualize particular pathways of interest in Reactome, the function viewPathway() can be used, https://yulab-smu.top/biomedical-knowledge-mining-book/reactomepa.html#pathway-visualization")
print("Here all the pathways that may be of interest (i..e pval < 0.05) are shown, but without coloring because it would change for each case... please redo if required adding the parameter 'foldChange=' in the function")
